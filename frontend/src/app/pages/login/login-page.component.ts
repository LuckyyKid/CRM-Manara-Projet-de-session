              ...
              <div class="row g-0">
                <div class="col-lg-5 p-4 p-lg-5">
                  <div class="mm-auth-aside">
                    <div class="mm-auth-logo-wrap">
                      <img class="mm-auth-logo" src="/images/manara-logo.svg" alt="Logo Manara">
                    </div>
                    ...
                    <ul class="mm-auth-list">
                      <li>
                        <span class="mm-auth-list-icon" aria-hidden="true">
                        <svg class="mm-auth-list-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor">
                          <path d="M5.072.56C6.157.265 7.31 0 8 0s1.843.265 2.928.56c1.11.3 2.229.655 2.887.87a1.54 1.54 0 0 1 1.044 1.262c.596 4.477-.787 7.795-2.465 9.99a10.76 10.76 0 0 1-2.517 2.453 7.1 7.1 0 0 1-1.048.625c-.28.132-.581.24-.829.24s-.548-.108-.829-.24a7.1 7.1 0 0 1-1.048-.625 10.76 10.76 0 0 1-2.517-2.453C1.928 10.487.545 7.169 1.141 2.692A1.54 1.54 0 0 1 2.185 1.43 63 63 0 0 1 5.072.56"/>
                          <path fill="#fff" d="M10.854 5.646a.5.5 0 0 1 0 .708l-3.25 3.25a.5.5 0 0 1-.708 0l-1.75-1.75a.5.5 0 1 1 .708-.708L7.25 8.543l2.896-2.897a.5.5 0 0 1 .708 0"/>
                        </svg>
                        </span>
                      ...
                      <li>
                        <span class="mm-auth-list-icon" aria-hidden="true">
                        <svg class="mm-auth-list-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor">
                          <path d="M4 .5a.5.5 0 0 0-1 0V1H2a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2h-1V.5a.5.5 0 0 0-1 0V1H4zM1 4h14v10a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1z"/>
                          <path d="M10.854 7.146a.5.5 0 0 1 0 .708l-2.75 2.75a.5.5 0 0 1-.708 0l-1.25-1.25a.5.5 0 1 1 .708-.708L7.75 9.543l2.396-2.397a.5.5 0 0 1 .708 0"/>
                        </svg>
                        </span>
                        <span>Planning et inscriptions</span>
                      </li>
                      <li>
                        <span class="mm-auth-list-icon" aria-hidden="true">
                        <svg class="mm-auth-list-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor">
                          <path d="M8 16a2 2 0 0 0 1.985-1.75h-3.97A2 2 0 0 0 8 16M8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92z"/>
                        </svg>
                        </span>
                        <span>Notifications a jour</span>
                      </li>
                    </ul>
                  </div>
                </div>
