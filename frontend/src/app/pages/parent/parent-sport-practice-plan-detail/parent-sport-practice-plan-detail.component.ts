    ...
    <div class="container py-4">
      <div class="mm-page-head">
        ...
        <div class="mm-page-actions">
          <a class="btn btn-outline-primary" routerLink="/parent/sport-practice-plans">Retour a la liste</a>
        </div>
      </div>
      ...
      <ng-container *ngIf="!loading() && plan() as item">
        <div class="card mm-card-shadow">
          <div class="card-body">
            <h2 class="mm-panel-title">Comment utiliser cette fiche</h2>
          ...
          <div class="col-12" *ngFor="let practiceItem of item.items">
            <div class="card mm-card-shadow">
              <div class="card-body">
                ...
                <div class="text-secondary mt-2" *ngIf="practiceItem.safetyTip"><strong>Conseil securite :</strong> {{ practiceItem.safetyTip }}</div>
              </div>
            </div>
          </div>
        </div>
