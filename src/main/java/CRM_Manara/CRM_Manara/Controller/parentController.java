...
public class parentController {
    ...
    public String createEnfant(@RequestParam("nom") String nom,
                               ...
                               Principal principal,
                               RedirectAttributes redirectAttributes, @Valid Enfant enfant, BindingResult bindingResult, Model model) {
        String email = principal.getName();
        if (bindingResult.hasErrors()) {
            model.addAttribute("erreurs", bindingResult.getAllErrors());
            return "parent/parentEnfantNew";
        }
