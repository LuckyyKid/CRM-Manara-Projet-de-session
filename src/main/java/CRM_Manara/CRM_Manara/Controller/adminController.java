...
public class adminController {
    ...
    public String newActivity(Model model) {
        ...
        model.addAttribute("activite", new Activity());
    ...
    public String createActivity(@RequestParam("name") String name,
                                 ...
                                 RedirectAttributes redirectAttributes, @Valid Activity activity, BindingResult bindingResult, Model model) {
    ...
    public String newAnimateur(Model model) {
        model.addAttribute("animateur", new Animateur());
    ...
    public String createAnimateur(@RequestParam("nom") String nom,
                                  ...
                                  RedirectAttributes redirectAttributes, @Valid Animateur animateur, BindingResult bindingResult, Model model) {
        if (bindingResult.hasErrors()) {
            model.addAttribute("errors", bindingResult.getAllErrors());
        }
